...
export function MetricCard({ label, value, isCurrency, trend, trendPositive = true, icon, iconBg = "bg-navy-100" }: MetricCardProps) {
  return (
    <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className={cn("w-10 h-10 rounded-full flex items-center justify-center text-navy-700", iconBg)}>
          {icon}
        </div>
      </div>
