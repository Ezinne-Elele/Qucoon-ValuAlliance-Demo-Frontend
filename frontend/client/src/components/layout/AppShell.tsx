...
import { 
  ...
  ReportingIcon, RegulatoryIcon, UsersIcon, AuditIcon, DocumentIcon, 
  CorporateActionsIcon, BellIcon, SearchIcon, LogoutIcon, NairaIcon, cn
} from '../icons/Icons';
  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Client Reports", path: "/client-reports", icon: ReportingIcon },
      ]
    },
    {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="w-64 bg-navy-900 text-white flex flex-col flex-shrink-0">
        <div className="h-16 flex flex-col justify-center px-6 bg-navy-950 border-b border-gold-500/30">
          <h1 className="text-[15px] font-bold tracking-wide">ValuAlliance</h1>
          <span className="text-[10px] text-gold-400 uppercase tracking-widest">Asset Management</span>
        </div>
        ...
        <div className="p-4 border-t border-navy-700 bg-navy-950">
          ...
          <div className="flex items-center justify-between text-gray-400">
            <button className="p-1.5 hover:text-white hover:bg-navy-800 rounded transition-colors relative">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0 z-10">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-4 border-l pl-4 border-gray-200">
              <p className="text-[13px] text-gray-500 font-medium">Monday, 23 February 2026</p>
            </div>
          </div>
        </header>
